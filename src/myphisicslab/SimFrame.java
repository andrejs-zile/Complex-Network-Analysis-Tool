...
class SimWindowAdapter extends WindowAdapter {
  ...
  public void windowDeactivated(WindowEvent e) {
    ...
    //applet.stop(); //Commented out to stop causing pause when off focus
  }
...
/** SimFrame is only used when running as an application;  it provides
  ...
  */
public class SimFrame extends JFrame implements AppletStub, AppletContext, ActionListener {
  ...
  public SimFrame(JApplet applet)  {
    setTitle("Complex Network Analysis Tool"); //changed the title
  ...
  */
  public String getParameter(String name) {
    if (name.equalsIgnoreCase("simulation"))
			return "Complex Network with Forced Vibrations"; //Default simulation to load once open
      //return "pendulum 2";
